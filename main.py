...
parser.add_argument('--start_epoch', type=int, default=14, help='Starting epoch for continuing training')
...
parser.add_argument('--file_list', type=str, default='train_lr.txt')
...
parser.add_argument('--pretrained_sr', default='4x_gpu02.chessRBPNF7_epoch_13.pth', help='sr pretrained base model')
...
if opt.model_type == 'RBPN':
    model = RBPN(num_channels=3, base_filter=64,  feat = 64, num_stages=3, n_resblock=4, nFrames=opt.nFrames, scale_factor=opt.upscale_factor) 
